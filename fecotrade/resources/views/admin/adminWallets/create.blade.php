...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.adminWallet.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.admin-wallets.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="wallet_name">{{ trans('cruds.adminWallet.fields.wallet_name') }}</label>
                <input class="form-control {{ $errors->has('wallet_name') ? 'is-invalid' : '' }}" type="text" name="wallet_name" id="wallet_name" value="{{ old('wallet_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('wallet_no') ? 'is-invalid' : '' }}" type="text" name="wallet_no" id="wallet_no" value="{{ old('wallet_no', '') }}" required>
