...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.miningWallet.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.mining-wallets.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="user">{{ trans('cruds.miningWallet.fields.user') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.miningWallet.fields.user_helper') }}</span>
            </div>
            <div class="form-group">
