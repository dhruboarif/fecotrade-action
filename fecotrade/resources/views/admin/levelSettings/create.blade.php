...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.levelSetting.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.level-settings.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="level_1">{{ trans('cruds.levelSetting.fields.level_1') }}</label>
                <input class="form-control {{ $errors->has('level_1') ? 'is-invalid' : '' }}" type="number" name="level_1" id="level_1" value="{{ old('level_1', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('level_2') ? 'is-invalid' : '' }}" type="number" name="level_2" id="level_2" value="{{ old('level_2', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('level_3') ? 'is-invalid' : '' }}" type="number" name="level_3" id="level_3" value="{{ old('level_3', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('level_4') ? 'is-invalid' : '' }}" type="number" name="level_4" id="level_4" value="{{ old('level_4', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('level_5') ? 'is-invalid' : '' }}" type="number" name="level_5" id="level_5" value="{{ old('level_5', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('level_6') ? 'is-invalid' : '' }}" type="number" name="level_6" id="level_6" value="{{ old('level_6', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('level_7') ? 'is-invalid' : '' }}" type="number" name="level_7" id="level_7" value="{{ old('level_7', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('level_8') ? 'is-invalid' : '' }}" type="number" name="level_8" id="level_8" value="{{ old('level_8', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('level_9') ? 'is-invalid' : '' }}" type="number" name="level_9" id="level_9" value="{{ old('level_9', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('level_10') ? 'is-invalid' : '' }}" type="number" name="level_10" id="level_10" value="{{ old('level_10', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('level_11') ? 'is-invalid' : '' }}" type="number" name="level_11" id="level_11" value="{{ old('level_11', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('level_12') ? 'is-invalid' : '' }}" type="number" name="level_12" id="level_12" value="{{ old('level_12', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('level_13') ? 'is-invalid' : '' }}" type="number" name="level_13" id="level_13" value="{{ old('level_13', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('level_14') ? 'is-invalid' : '' }}" type="number" name="level_14" id="level_14" value="{{ old('level_14', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('level_15') ? 'is-invalid' : '' }}" type="number" name="level_15" id="level_15" value="{{ old('level_15', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('level_16') ? 'is-invalid' : '' }}" type="number" name="level_16" id="level_16" value="{{ old('level_16', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('level_17') ? 'is-invalid' : '' }}" type="number" name="level_17" id="level_17" value="{{ old('level_17', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('level_18') ? 'is-invalid' : '' }}" type="number" name="level_18" id="level_18" value="{{ old('level_18', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('level_19') ? 'is-invalid' : '' }}" type="number" name="level_19" id="level_19" value="{{ old('level_19', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('level_20') ? 'is-invalid' : '' }}" type="number" name="level_20" id="level_20" value="{{ old('level_20', '') }}" step="0.01" required>
