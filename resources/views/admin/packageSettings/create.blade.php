...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.packageSetting.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.package-settings.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_roi') ? 'is-invalid' : '' }}" type="number" name="total_roi" id="total_roi" value="{{ old('total_roi', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('daily_roi') ? 'is-invalid' : '' }}" type="number" name="daily_roi" id="daily_roi" value="{{ old('daily_roi', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('validity') ? 'is-invalid' : '' }}" type="number" name="validity" id="validity" value="{{ old('validity', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_of_levels') ? 'is-invalid' : '' }}" type="number" name="no_of_levels" id="no_of_levels" value="{{ old('no_of_levels', '') }}" step="1" required>
